...
function swap(i,j)
{
    ...
    div_update(divs[i],div_sizes[i],"#C88EA7");//Color update
...
function max_heapify(n,i)
{
    ...
    if(l<n && div_sizes[l]>div_sizes[largest])
    {
        if(largest!=i)
        {
            div_update(divs[largest],div_sizes[largest],"#C88EA7");//Color update
        }

        largest=l;

        div_update(divs[largest],div_sizes[largest],"#73BBC9");//Color update
    }
...
function heap_sort()
{
    ...
    for(var i=array_size-1;i>0;i--)
    {
        ...
        div_update(divs[i],div_sizes[i],"#F5A31A");//Color update
